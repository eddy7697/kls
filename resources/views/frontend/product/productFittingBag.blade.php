...
@section('custom-style')
    ...
    <style media="screen">
        .mega-menu .product .mega-menu-list ul li:nth-child(3) a{
...
@section('custom-script')
    <script src="{{ asset('js/product-fitting-bag.js') }}"></script>
...
@section('content')
    <div id="product-fitting-bag">
        <product-fitting-bag></product-fitting-bag>
    </div>
@endsection
