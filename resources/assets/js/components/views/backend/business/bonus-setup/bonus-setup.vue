        ...
        <div class="col-md-6">
            <div v-if="isLoaded" class="panel panel-default">
                ...
                <div v-if="isSetuped" class="panel-footer">
                    <button v-if="isDirty" type="button" class="btn btn-primary btn-sm btn-block" @click="updateBonusParameter()">儲存參數</button>
                    <button v-else type="button" class="btn btn-primary btn-sm btn-block" name="button" disabled>儲存參數</button>
                </div>
                <div v-else class="panel-footer">
                    <button v-if="isDirty" type="button" class="btn btn-primary btn-sm btn-block" @click="addBonusParameter()">新增參數</button>
                    <button v-else type="button" class="btn btn-primary btn-sm btn-block" name="button" disabled>儲存參數</button>
                </div>
            </div>
        </div>
