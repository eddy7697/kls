...
// witness view
mix.js('resources/assets/js/components/views/backend/witness/add-witness/add-witness.js', 'public/js/backend')
   .js('resources/assets/js/components/views/backend/witness/witness-list/witness-list.js', 'public/js/backend');
